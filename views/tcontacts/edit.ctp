<div class="tcontacts form">
<?php echo $form->create('Tcontact');?>
	<fieldset>
 		<legend><?php __('Edit Tcontact');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action' => 'delete', $form->value('Tcontact.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Tcontact.id'))); ?></li>
