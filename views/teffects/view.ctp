<div class="teffects view">
<h2><?php  __('Teffect');?></h2>
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit Teffect', true), array('action' => 'edit', $teffect['Teffect']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete Teffect', true), array('action' => 'delete', $teffect['Teffect']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $teffect['Teffect']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($teffect['Track'] as $track):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
