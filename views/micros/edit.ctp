...
<?php echo $form->create('Micro');?>
	<fieldset>
 		<legend><?php __('Edit Micro');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action' => 'delete', $form->value('Micro.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Micro.id'))); ?></li>
