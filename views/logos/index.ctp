...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action' => 'view', $logo['Logo']['id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action' => 'edit', $logo['Logo']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action' => 'delete', $logo['Logo']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $logo['Logo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
